...
<body>
    ...
    <section class="section">
        ...
        <video src="https://media.istockphoto.com/videos/lombok-waterfall-video-id135931235" muted loop
            autoplay></video>
      ...
      <div class="social">
        <a href="index_main.php" class="btt">EXPLORE</a>
      </div>
